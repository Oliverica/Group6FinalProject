Feature: Creating a new employee related scenarios
  ...
  @addEmployee @addByFullName @verifyEmployeeInDB @passed
  ...
  @addEmployee @addByID @verifyEmployeeInDB @passed
  ...
  @addEmployee @errorMessageValidation @errorMessage @passed
  ...
  @addEmployee @existingIdError @failedToSave @errorMessageValidation @passed
