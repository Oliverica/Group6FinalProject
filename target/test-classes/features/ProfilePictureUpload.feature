Feature: Profile Photo Upload
  ...
  @profilePhotoUpload @unsupportedFileType @passed @marina
  ...
  @profilePhotoUpload @oversizedFile @passed @marina
  ...
  @profilePhotoUpload @incorrectDimensions @passed @marina
  ...
  @profilePhotoUpload @validProfilePhoto @passed @marina
